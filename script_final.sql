...
INSERT INTO PERSONA (PERSONA_ID, GENERO_ID, NUMERO_IDENTIFICACION, NOMBRE, APELLIDO, FECHA_NAC, PAIS_NAC, CIUDAD_NAC, MOSTRAR)
VALUES (4, 2, 111111111, 'Luisa', 'Mart�nez', TO_DATE('1990-03-25', 'YYYY-MM-DD'), 'OtroPais2', 'OtraCiudad2', 1);
INSERT INTO PERSONA (PERSONA_ID, GENERO_ID, NUMERO_IDENTIFICACION, NOMBRE, APELLIDO, FECHA_NAC, PAIS_NAC, CIUDAD_NAC, MOSTRAR)
...
INSERT INTO PERSONA (PERSONA_ID, GENERO_ID, NUMERO_IDENTIFICACION, NOMBRE, APELLIDO, FECHA_NAC, PAIS_NAC, CIUDAD_NAC, MOSTRAR)
VALUES (13, 1, 111111111, 'Javier', 'Fern�ndez', TO_DATE('1975-04-15', 'YYYY-MM-DD'), 'PaisE', 'CiudadE', 1);
INSERT INTO PERSONA (PERSONA_ID, GENERO_ID, NUMERO_IDENTIFICACION, NOMBRE, APELLIDO, FECHA_NAC, PAIS_NAC, CIUDAD_NAC, MOSTRAR)
...
CREATE OR REPLACE PACKAGE aeropuerto_crud AS
    ...
    -- Procedimiento para leer informaci�n de un aeropuerto
...
CREATE OR REPLACE PACKAGE BODY aeropuerto_crud AS
    ...
    -- Implementaci�n de funci�n para leer un aeropuerto
    PROCEDURE leer_aeropuerto(
        p_aeropuerto_id IN NUMBER, 
        p_aeropuerto_info OUT aeropuerto_type) 
    IS
...
-----------------------------------------------------------------------------------
--TRIGGERS
--verifica que el avi�n asignado no est� asignado a otro vuelo en el mismo intervalo de tiempo
...
BEGIN
    ...
    IF :NEW.cantidad_pasajeros > v_capacidad_pasajeros_avion THEN
        RAISE_APPLICATION_ERROR(
            -20204, 
            'No hay mas puestos en el avi�n'
        );
    END IF;
